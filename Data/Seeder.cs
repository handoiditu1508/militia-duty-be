    ...
    public static class Seeder
    {
        ...
        private static void SeedMilitias(MilitiaContext context, MilitiaOptions options)
        {
            context.Militias.AddRange(
                ...
                new() { Id = 12, Name = "Phương", DutyDateScore = options.OnDutyRate * 2 },
                new() { Id = 13, Name = "Kiệt", DutyDateScore = options.OnDutyRate * 3 },
                new() { Id = 14, Name = "Lợi", DutyDateScore = options.OnDutyRate * 5 },
                new() { Id = 15, Name = "Thạch", DutyDateScore = options.OnDutyRate * 2 },
        ...
        private static void SeedDutyDates(MilitiaContext context)
        {
            ...
            context.MilitiaDutyDates.AddRange(
                ...
                new() { DutyDateId = "20240217", MilitiaId = 18 },
            ...
            context.MilitiaDutyDates.AddRange(
                ...
                new() { DutyDateId = "20240220", MilitiaId = 18 },
