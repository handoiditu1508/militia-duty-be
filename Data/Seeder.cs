    ...
    public static class Seeder
    {
        ...
        private static void SeedMilitias(MilitiaContext context, MilitiaOptions options)
        {
            context.Militias.AddRange(
                ...
                new() { Id = 4, Name = "Châu", DutyDateScore = (ushort)options.OnDutyRate },
                new() { Id = 5, Name = "Thắng", DutyDateScore = (ushort)options.OnDutyRate },
                new() { Id = 6, Name = "Đạt", DutyDateScore = (ushort)options.OnDutyRate },
                new() { Id = 7, Name = "Thịnh", DutyDateScore = (ushort)options.OnDutyRate },
