...
{
    /// <inheritdoc />
    public partial class Update_TaskRule_Rename : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskRules", x => new { x.TaskId, x.RuleId });
                    table.ForeignKey(
                        name: "FK_TaskRules_Rules_RuleId",
                        column: x => x.RuleId,
                        principalTable: "Rules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskRules_Tasks_TaskId",
                        column: x => x.TaskId,
